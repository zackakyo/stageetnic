...
<aside class="col-md col-lg border" role="main" >
        <div class="single_service wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                ...
                <div class="form mb-3">
                        <div class="col-lg-8">
                                <form method="post" class="form" action="{{ Route('mysql.update', $mysql->id) }}">
                                        @csrf
                                        @method('PATCH')
                                        <div class="form-group" >
                                                <label for="version" class="text-white font-weight-bold" >version</label>
                                                <input type="text" id="version"  name="version" class="form-control" aria-placeholder="version" value="{{ $mysql->version }}" required  >
                                        </div>
                                        <div class="form-group">                                    
