...
<aside class="col-md col-lg border " role="main" 
        <div class="single_service wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                ...
                <div class="form border border-warning" >
                                <div class="col-lg-8">
                                <form method="post" class="form " action="{{ Route('mysql.update', $mysql->id) }}" novalidate="novalidate">
        
        @method('PATCH')
        @csrf
                <div class="form-group d-flex " >
                        <label for="version">version</label>
                        <input type="text" id="version" name="version" class="form-control" placeholder="version" value="{{ $mysql->version }}" required  >
                 </div>   
