            ...
            <main class="col-lg col-md border">
                <div class="single_service wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".5s">
                    ...
                    <h2 class="text-white">Les versions de MYSQL <a href="{{ route('mysql.create') }}" class="btn btn-success">Ajouter</a> </h2>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('mysql.edit', $mysql->id) }}" class="btn btn-warning" > modifier</a>
            </td>
            <td>
